function scan = conf_seq(varargin)
	...
	defaultArgs = struct(...
		...
		...
		... Pulse modification
		'pulse_modifier_args',   struct('pulse_identifier', ''), ... % Add this identifier to the new 
		'pulse_modifier',        false, ...							  % Automatically add a custom pulse in sequence
		'pulse_modifier_fn',     @tune.add_dbz_fid, ...   % Can specify a custom function here which modifies the variable a below
		...
		... Saving variables
