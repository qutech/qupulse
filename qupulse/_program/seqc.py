...
class WaveformMemory:
    ...
    def waveform_declaration(self,ct_dict) -> str:
        ...
        for wave_placeholder, wave_infos in self._concatenated_waveforms_iter():
            ...
            ct_index += 1
            #TODO: this can be more efficient. correspondent to ct is fine however, since way more waveforms than ct entries available.
            wave_table_index += 1
...
class ProgramWaveformManager:
    ...
    def clear_requested(self):        
        ...
        #probably unnecessary and only causes errors. put in try except.
        try:
...
class HDAWGProgramManager:
    ...
    class Constants:
        ...
        # HOWEVER, this still induces errors. Disable userreg more or less completely
...
class WaveformPlayback(SEQCNode):
    ...
    ENABLE_DYNAMIC_RATE_REDUCTION = True
