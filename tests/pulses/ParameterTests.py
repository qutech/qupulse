...
class ParameterDeclarationTest(unittest.TestCase):
    ...
    def test_init_constant_values(self) -> None:
        ...
        self.assertRaises(ValueError, ParameterDeclaration, 'test', foo='bar')
        self.assertRaises(TypeError, ParameterDeclaration, 'test', min='foo')
        self.assertRaises(TypeError, ParameterDeclaration, 'test', max=None)
        self.assertRaises(TypeError, ParameterDeclaration, 'test', default='foo')
