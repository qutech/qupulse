...
class ParameterDeclarationTest(unittest.TestCase):
    ...
    def __test_valid_params(self, **kwargs) -> None:
        parameter_decl = ParameterDeclaration(**kwargs)
        ...
        if not 'default' in kwargs:
            kwargs['default'] = None
        self.assertEqual(kwargs['min'], parameter_decl.min_value)
        self.assertEqual(parameter_decl.min_value, parameter_decl.get_min_value())
        self.assertEqual(kwargs['max'], parameter_decl.max_value)
        self.assertEqual(parameter_decl.max_value, parameter_decl.get_max_value())
        self.assertEqual(kwargs['default'], parameter_decl.default_value)
        self.assertEqual(parameter_decl.default_value, parameter_decl.get_default_value())
        if kwargs['default'] is None:
            self.assertRaises(NoDefaultValueException, parameter_decl.get_default_parameter)
        else:
            self.assertIsInstance(parameter_decl.get_default_parameter(), ConstantParameter)
            self.assertEqual(kwargs['default'], parameter_decl.get_default_parameter().get_value())

    def test_no_values(self) -> None:
        self.__test_valid_params()
        
    def test_valid_min_value(self) -> None:
        self.__test_valid_params(min=0.1)
        self.__test_valid_params(min=0)
        self.__test_valid_params(min=-0.1)
    ...
    def test_valid_max_value(self) -> None:
        self.__test_valid_params(max=0.1)
        self.__test_valid_params(max=0)
        self.__test_valid_params(max=-0.1)
    ...
    def test_valid_default_value(self) -> None:
        self.__test_valid_params(default=0.1)
        self.__test_valid_params(default=0)
        self.__test_valid_params(default=-0.1)
    ...
    def test_valid_min_max_value(self) -> None:
        self.__test_valid_params(min=0.1, max=0.1)
        self.__test_valid_params(min=0.1, max=0.15)
        self.__test_valid_params(min=0, max=0.15)
        self.__test_valid_params(min=-0.1, max=0.15)
        self.__test_valid_params(min=-0.1, max=0)
        self.__test_valid_params(min=-0.1, max=-0.09)
    ...
    def test_valid_min_default_value(self) -> None:
        self.__test_valid_params(min=0.1, default=0.1)
        self.__test_valid_params(min=0.1, default=0.15)
        self.__test_valid_params(min=0, default=0.15)
        self.__test_valid_params(min=-0.1, default=0.15)
        self.__test_valid_params(min=-0.1, default=0)
        self.__test_valid_params(min=-0.1, default=-0.05)
    ...
    def test_valid_default_max_value(self) -> None:
        self.__test_valid_params(default=0.12, max=0.12)
        self.__test_valid_params(default=0.12, max=0.15)
        self.__test_valid_params(default=0, max=0.15)
        self.__test_valid_params(default=-0.12, max=0.15)
        self.__test_valid_params(default=-0.12, max=0)
        self.__test_valid_params(default=-0.12, max=0.1)
    ...
    def test_valid_min_max_default_value(self) -> None:
        self.__test_valid_params(min=0.11, default=0.12, max=0.13)
        self.__test_valid_params(min=0, default=0.12, max=0.13)
        self.__test_valid_params(min=-0.11, default=0.12, max=0.13)
        self.__test_valid_params(min=-0.11, default=0, max=0.13)
        self.__test_valid_params(min=-0.11, default=-0.10, max=0.13)
        self.__test_valid_params(min=-0.11, default=-0.10, max=0)
        self.__test_valid_params(min=-0.11, default=-0.10, max=-0.09)
        self.__test_valid_params(min=0.3, default=0.3, max=0.3)
        
    def __test_is_parameter_valid(self, parameterValue: float, expectedResult: bool, **kwargs) -> None:
        parameter = ConstantParameter(parameterValue)
        parameter_decl = ParameterDeclaration(**kwargs)
        self.assertEqual(expectedResult, parameter_decl.is_parameter_valid(parameter))
        
    def test_no_values_is_parameter_valid(self) -> None:
        self.__test_is_parameter_valid(0.1, True)
        self.__test_is_parameter_valid(0, True)
        self.__test_is_parameter_valid(-0.1, True)
        
    def test_min_value_is_parameter_valid(self) -> None:
        self.__test_is_parameter_valid(0.2, True, min=0.1)
        self.__test_is_parameter_valid(0.1, True, min=0.1)
        self.__test_is_parameter_valid(-0.3, False, min=0.4)
        
    def test_max_value_is_parameter_valid(self) -> None:
        self.__test_is_parameter_valid(-0.3, True, max=0.1)
        self.__test_is_parameter_valid(0.1, True, max=0.1)
        self.__test_is_parameter_valid(0.4, False, max=-1.9)
        
    def test_min_max_value_is_parameter_valid(self) -> None:
        self.__test_is_parameter_valid(23.1, True, min=0.7, max=40.2)
        self.__test_is_parameter_valid(0.7, True, min=0.7, max=40.2)
        self.__test_is_parameter_valid(40.2, True, min=0.7, max=40.2)
        self.__test_is_parameter_valid(-5.3, False, min=0.7, max=40.2)
        self.__test_is_parameter_valid(0, False, min=-3.2, max=-2.6)

        
class TimeParameterDeclarationTest(unittest.TestCase):

    def __test_valid_params(self, **kwargs) -> None:
        parameter_decl = TimeParameterDeclaration(**kwargs)
        if not 'min' in kwargs:
            kwargs['min'] = 0
        if not 'max' in kwargs:
            kwargs['max'] = None
    ...
    def test_valid_min_value(self):
        self.__test_valid_params(min=0)
        self.__test_valid_params(min=3)
    ...
    def test_valid_max_value(self):
        self.__test_valid_params(max=0)
        self.__test_valid_params(max=1)
    ...
    def test_valid_default_value(self):
        self.__test_valid_params(default=0)
        self.__test_valid_params(default=5)
    ...
    def test_valid_min_max_value(self):
        self.__test_valid_params(min=0, max=0)
        self.__test_valid_params(min=0, max=5)
        self.__test_valid_params(min=5, max=5)
        self.__test_valid_params(min=6, max=11)
    ...
    def test_valid_min_default_value(self):
        self.__test_valid_params(min=0, default=0)
        self.__test_valid_params(min=0, default=5)
        self.__test_valid_params(min=5, default=5)
        self.__test_valid_params(min=6, default=11)
    ...
    def test_valid_default_max_value(self):
        self.__test_valid_params(default=0, max=0)
        self.__test_valid_params(default=0, max=5)
        self.__test_valid_params(default=5, max=5)
        self.__test_valid_params(default=6, max=11)
    ...
    def test_valid_min_default_max_value(self):
        self.__test_valid_params(min=0, default=0, max=0)
        self.__test_valid_params(min=0, default=0, max=7)
        self.__test_valid_params(min=0, default=3, max=7)
        self.__test_valid_params(min=3, default=3, max=7)
        self.__test_valid_params(min=3, default=7, max=7)
        self.__test_valid_params(min=7, default=7, max=7)
    ...
    def test_no_values_is_parameter_valid(self) -> None:
        self.__test_is_parameter_valid(0.1, False)
        self.__test_is_parameter_valid(-0.1, False)
        self.__test_is_parameter_valid(-2, False)
        self.__test_is_parameter_valid(0, True)
        self.__test_is_parameter_valid(1, True)
        
    def test_min_value_is_parameter_valid(self) -> None:
        self.__test_is_parameter_valid(0.2, False, min=1)
        self.__test_is_parameter_valid(1.1, False, min=1)
        self.__test_is_parameter_valid(1, True, min=1)
        self.__test_is_parameter_valid(3, True, min=2)
        
    def test_max_value_is_parameter_valid(self) -> None:
        self.__test_is_parameter_valid(0.3, False, max=4)
        self.__test_is_parameter_valid(9.8, False, max=3)
        self.__test_is_parameter_valid(3, True, max=3)
        self.__test_is_parameter_valid(5, True, max=8)
        
    def test_min_max_value_is_parameter_valid(self) -> None:
        self.__test_is_parameter_valid(0.1, False, min=4, max=23)
        self.__test_is_parameter_valid(8.3, False, min=4, max=23)
        self.__test_is_parameter_valid(28.9, False, min=4, max=23)
        self.__test_is_parameter_valid(3, False, min=4, max=23)
        self.__test_is_parameter_valid(40, False, min=4, max=23)
        self.__test_is_parameter_valid(4, True, min=4, max=23)
