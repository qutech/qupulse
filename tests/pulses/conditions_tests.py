...
class HardwareConditionTest(unittest.TestCase):
    ...
    def test_build_sequence_loop(self) -> None:        
        ...
        self.assertEqual([DummyInstruction(), CJMPInstruction(trigger, body_block, 0)], block.instructions, "The expected conditional jump was not generated by HardwareConditon.")
